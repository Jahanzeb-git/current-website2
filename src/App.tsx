...
import lightimg from '../Assets/images/light.jpg'; // Imported light theme image
...
function AppContent({ isDocumentationOpen, toggleDocumentation }) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      {/* Light mode background using imported image */}
      <div
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1647346425804-34383b95644b?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}
      />
