...
function AppContent({ isDocumentationOpen, toggleDocumentation }) {
  ...
  const lightImage = "url('https://images.unsplash.com/photo-1702285566373-bb7744adcbe7?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')";
