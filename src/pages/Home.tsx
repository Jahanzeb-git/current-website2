...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        <StarDecoration>
          <h1 className="text-6xl md:text-8xl font-extrabold mb-8 bg-gradient-to-r from-[#025A4E] to-teal-600 dark:from-emerald-400 dark:to-teal-400 text-transparent bg-clip-text">
              I'm Jahánzeb. <br />
              <span className="block">Ai Enthusiást.</span>
          </h1>
        </StarDecoration>

        <p className="mt-16 text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-medium">
