...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        <StarDecoration>
          <h1 className="text-7xl md:text-8xl font-extrabold mb-8 bg-gradient-to-r from-[#025A4E] to-teal-600 dark:from-emerald-400 dark:to-teal-400 text-transparent bg-clip-text">
              I'm Jahánzeb. <br />
