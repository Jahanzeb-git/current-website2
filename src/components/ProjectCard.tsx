...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div
      ...
      className="group relative bg-white/90 dark:bg-gray-800/90 rounded-2xl shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-1 will-change-transform cursor-pointer"
    >
      <div className="aspect-video overflow-hidden">
        <img
          ...
          loading="lazy"
          decoding="async"
          className="w-full h-full object-cover transition-transform duration-700 ease-in-out will-change-transform group-hover:scale-110"
        />
      </div>
      <div className="p-6">
